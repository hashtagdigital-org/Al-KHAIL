    ...
    <div className="min-h-screen bg-gradient-to-b from-background via-muted/20 to-background">
      ...
      <nav className="sticky top-0 z-50 bg-background/95 backdrop-blur-sm border-b border-border">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <Link to="/" className="flex items-center gap-2 text-brand-red hover:text-luxury-gold transition-colors">
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                className={isFavorite ? "text-brand-red border-brand-red" : ""}
              >
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-12 animate-fade-in">
          <div className="relative overflow-hidden rounded-2xl aspect-[21/9] mb-4">
            <img
            ...
            <Badge className="absolute top-4 right-4 bg-luxury-gold text-black font-semibold">
              {property.completion}
            </Badge>
          </div>
              ...
              {images.map((img, index) => (
                <div
                  ...
                  className={`relative overflow-hidden rounded-lg aspect-video cursor-pointer transition-all duration-300 ${
                    selectedImage === index
                      ? "ring-4 ring-brand-red scale-105"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="animate-fade-in">
              <h1 className="text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-brand-red via-luxury-gold to-brand-red bg-clip-text text-transparent">
                {property.title}
              </h1>
              ...
              <p className="text-4xl font-bold text-brand-red mb-6">{property.price}</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 animate-fade-in">
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-lg font-semibold text-foreground">{property.developer}</p>
                  <p className="text-sm text-muted-foreground mt-2">Trusted developer with premium projects</p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-foreground">{property.paymentPlan}</p>
                </CardContent>
              </Card>
            </div>
          </div>
          ...
          <div className="lg:col-span-1">
            <Card className="sticky top-24 shadow-xl border-border/50 animate-fade-in">
              <CardContent className="p-8">
                <div className="text-center mb-6">
                  <h3 className="text-2xl font-bold mb-2">Contact Alkhail</h3>
                  <p className="text-sm text-muted-foreground">Get in touch with our property experts</p>
                </div>

                <div className="space-y-4">
                  <Button
                    className="w-full bg-gradient-to-r from-brand-red to-brand-red-dark hover:from-brand-red-dark hover:to-brand-red text-white h-12"
                  ...
                  <Button
                    variant="outline"
                    className="w-full border-brand-red/50 text-brand-red hover:bg-brand-red hover:text-white h-12"
                  ...
                  <Button
                    variant="outline"
                    className="w-full border-luxury-gold/50 text-luxury-gold hover:bg-luxury-gold hover:text-black h-12"
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-center gap-2">
                    ...
                    <a href={`tel:${property.contact.phone}`} className="hover:text-brand-red transition-colors">
                      {property.contact.phone}
                    </a>
                  </div>
                  <div className="flex items-center gap-2">
                    <Mail className="w-4 h-4 text-brand-red" />
                    <a href={`mailto:${property.contact.email}`} className="hover:text-brand-red transition-colors">
                      {property.contact.email}
                    </a>
                  </div>
                  <div className="flex items-center gap-2">
                    <MessageCircle className="w-4 h-4 text-brand-red" />
                    <a href={`https://wa.me/${property.contact.whatsapp.replace(/[^0-9]/g, '')}`} className="hover:text-brand-red transition-colors" target="_blank" rel="noopener noreferrer">
                      {property.contact.whatsapp}
                    </a>
                  </div>
                </div>

                <div className="mt-6 p-4 bg-gradient-to-r from-brand-red/10 to-luxury-gold/10 rounded-lg text-center">
                  <p className="text-xs text-muted-foreground mb-2">Trusted by</p>
                  <p className="text-lg font-bold bg-gradient-to-r from-brand-red to-luxury-gold bg-clip-text text-transparent">
                    Alkhail Real Estate
                  </p>
